...
df = pd.read_csv("D:\\Assignments\\Recommendtion system\\book.csv", encoding = 'latin-1')
...
df1.fillna(0, inplace = True) # Replaced null value with 0
df1
...
# it will recommend 'Classical Mythology' to 276729 and 'Decision in Normandy' & 'Clara Callan' to276726
...
# it will recommend 'Classical Mythology' to 276736 and 'Flu: The Story of the Great Influenza Pandemic' to 276726
...
# it will recommend 'Classical Mythology' to 276744 and 'The Kitchen God's Wife' & to276726
...
# it will recommend 'Classical Mythology' to 276754 and 'A Second Chicken Soup for the Woman's Soul' to 276726
...
# it will recommend 'Classical Mythology' to 276745 and 'What If?: The World's Foremost Military Histor' to 276726
